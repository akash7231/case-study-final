...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" errorPage="HRNotApproved.jsp"%>
...
<br><br>
	<table border="1" align="center" style="color : GreenYellow;">
		...
		Joining_Emp reg=new Joining_Emp();
			...
			//if(reg==null){
				//out.println("<h3><b>Needs Approval from HR</b></h3>");
				//throw new HRNotApprovedException("<h3><b>Needs Approval from HR</b></h3>");
			...
			<td>
				<form action="Decline" method="post">
					<input type="hidden" name="id" value=<%=reg.getApplication_id()%>>
					 ...
					 <input type="hidden" name="decline" value="userReject">
